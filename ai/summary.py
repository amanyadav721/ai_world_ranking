...
def resume_analysis(data,job_title:str, job_description:str) -> json:
    ...
    Strict Guideliness:
                    ...
                    8. Do not include Stray characters (e.g. \n, \x0b, smart quotes, etc.) Unexpected markdown (like ```json) or Hallucinations or partial responses (especially if job_title = "ANY)

                    9. Always return a valid JSON object with the specified structure, even if some fields are not applicable or data is missing.
    """
